...
FRAMEWORK_LINEAGE_API_NEEDS_UPDATE_TEXT := $(TOPDIR)vendor/morphos/build/core/apicheck_msg_current.txt

BUILD_RRO_SYSTEM_PACKAGE := $(TOPDIR)vendor/morphos/build/core/system_rro.mk

# Rules for QCOM targets
include $(TOPDIR)vendor/morphos/build/core/qcom_target.mk
