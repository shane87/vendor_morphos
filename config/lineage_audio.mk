...
ALARM_PATH := vendor/morphos/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/morphos/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/morphos/prebuilt/common/media/audio/ringtones
